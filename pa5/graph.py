...
# date: March 17, 2023
# file: graph.py is a python program that contains a graph and vertex class. 
# input: vertex or edges
# output: graph or search order
...
if __name__ == '__main__':
    ...
    path = g.DFS()
    print('DFS  by discovery time (preordering): ', path)
    assert path == [0, 1, 2, 3, 4, 5]
